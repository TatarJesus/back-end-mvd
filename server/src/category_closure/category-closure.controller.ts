...
export class CategoryClosureController {
  constructor(private readonly categoryClosureService: CategoryClosureService) {}
  ...
  findOne(@Param('ancestor_id') ancestor_id: number, @Param('descendant_id') descendant_id: number) {
    return this.categoryClosureService.findOne(ancestor_id, descendant_id);
  }

  @Put('/:ancestor_id/:descendant_id')
  update(@Param('ancestor_id') ancestor_id: number, @Param('descendant_id') descendant_id: number, @Body() updateCategoryClosureDto: UpdateCategoryClosureDto) {
    return this.categoryClosureService.update(ancestor_id, descendant_id, updateCategoryClosureDto);
  }

  @Delete('/:ancestor_id/:descendant_id')
  remove(@Param('ancestor_id') ancestor_id: number, @Param('descendant_id') descendant_id: number) {
